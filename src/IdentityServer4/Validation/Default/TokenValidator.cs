...
namespace IdentityServer4.Validation.Default
{
    internal class TokenValidator : ITokenValidator
    {
        ...
        public async Task<Models.TokenValidationResult> ValidateIdentityTokenAsync(string token, string clientId = null, bool validateLifetime = true)
        {
        ...
        public async Task<Models.TokenValidationResult> ValidateAccessTokenAsync(string token, string expectedScope = null)
        {
            ...
            Models.TokenValidationResult result;
        ...
        private async Task<Models.TokenValidationResult> ValidateJwtAsync(string jwt, IEnumerable<SecurityKeyInfo> validationKeys, bool validateLifetime = true, string audience = null)
        {
        ...
        private async Task<Models.TokenValidationResult> ValidateReferenceAccessTokenAsync(string tokenHandle)
        {
        ...
        private Models.TokenValidationResult Invalid(string error)
        {
            return new Models.TokenValidationResult
            {
                IsError = true,
