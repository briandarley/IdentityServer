...
using UNC.IdentityModel.Internal;

namespace UNC.IdentityModel.Client.Extensions;
...
public static class HttpClientDynamicRegistrationExtensions
{
        ...
        this HttpMessageInvoker client, DynamicClientRegistrationRequest request, CancellationToken cancellationToken = default)
    {
        ...
        clone.Content = new StringContent(
            JsonSerializer.Serialize(request.Document, Messages.ClientMessagesSourceGenerationContext.Default.DynamicClientRegistrationDocument),
            Encoding.UTF8,
            "application/json");
        clone.Prepare();
